...
class NewEntryForm {
     ...
     submitForm() {
        ...
        const doAjax = async () => {
            await fetch(`${backendUrl}/messages`, {
                ...
                window.alert("Unspecified error 1");
            });
        }
    ...
    private onSubmitResponse(data: any) {
        ...
        // Handle other errors with a less-detailed popup message
            ...
            window.alert("Unspecified error 2");
        }
    }
    ...
    private clickDelete(e: Event) {
        ...
        const doAjax = async () => {
            await fetch(`${backendUrl}/messages/${id}`, {
                ...
                console.warn('Something went wrong.', error);
                window.alert("Unspecified error 4");
            });
        }
    ...
    private clickEdit(e: Event) {
        ...
        const doAjax = async () => {
            await fetch(`${backendUrl}/messages/${id}`, {
                ...
                console.warn('Something went wrong.', error);
                window.alert("Unspecified error 5");
            });
        }
...
class EditEntryForm {
    ...
    init(data: any) {
        ...
        // Handle other errors with a less-detailed popup message
            ...
            window.alert("Unspecified error 6");
        }        
    }
    ...
    submitForm() {
        ...
        const doAjax = async () => {
            await fetch(`${backendUrl}/messages/${id}`, {
                ...
                console.warn('Something went wrong.', error);
                window.alert("Unspecified error 7");
            });
        }
    ...
    private onSubmitResponse(data: any) {
        ...
        // Handle other errors with a less-detailed popup message
            ...
            window.alert("Unspecified error 8");
        }
    }
